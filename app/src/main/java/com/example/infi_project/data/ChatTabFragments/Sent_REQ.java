...
import Adapter.Sent_Req_Adapter;

public class Sent_REQ extends Fragment {



    private static final String TAG = "RECEIVED_REQ";
    private Sent_Req_Adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sent__r_e_q, container, false);
    }
    ...
    private void readUsers() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Connections").child(mobileText).child("sent");
    ...
    private void initReceivedRecyclerView() {
        ...
        Sent_Req_Adapter userAdapter= new Sent_Req_Adapter(mobileText,getContext(),profileNameList,profileNumberList,profileImageList);
